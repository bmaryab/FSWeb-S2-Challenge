...
console.log("1 parametre ile: ", cumleKur("Hello World!"));
...
console.log("2 parametre ile: ", cumleKur("Hello ", "World!"));
...
console.log("5 parametre ile: ",bircumle);
...
function cumlelereDonustur(cumlelerDizisi, ayrac = ","){
	const yeniDizi = cumlelerDizisi.map(currentElement => currentElement.join(ayrac));
	return yeniDizi;
}
...
function paragrafOlustur(cumlelerDizisi, cumleKurFunc, cumlelereDonusturFunc){
	const yeniDizi = cumlelereDonusturFunc(cumlelerDizisi, " ");
	const paragraf = cumleKurFunc(yeniDizi[1],yeniDizi[3],yeniDizi[5],yeniDizi[7],yeniDizi[9]);
	return paragraf;
}
 ...
 */
//const mesajim = "Selam :) Nasılsın :D Bugünkü olay çok komikti :P ama sonra çok şaşırdık :o biraz da üzüldük :( ama yine de seviliyorsun <3"
...
//console.log(emojileriDonustur(mesajim, emojiler));
